...
def createFileStego(tree, path_file_extracted, output_stego_directory_path):
    ...
    if os.path.exists(output_stego_directory_path + '/' + input_file_name + '_stego.docx'):
        os.remove(output_stego_directory_path + '/' + input_file_name + '_stego.docx')
    os.rename(output_stego_directory_path + '/stego.zip', output_stego_directory_path + '/' + input_file_name + '_stego.docx')
        ...
        while i_run_elements <= len(run_elements):
            ...
            while count >= 1:
                ...
                # Caso b
                    ...
                    # optimization -> remove tree.write("./backend/output_stego/document.xml")
                    N = 1
                    count_txt_tag += 1
                i += 1
                count -= 1
