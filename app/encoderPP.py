...
def createSlideStego(tree, slide_filename):
    ...
    shutil.copy("stego/" + slide_filename, "stego/file_extracted/ppt/slides")
    os.remove('./stego/' + slide_filename)

# Crea il file ".pptx" contenente le slide steganografate
def createFileStego(path_file_extracted):
    ...
    if os.path.exists('./stego/' + input_file_name + '_stego.pptx'):
        os.remove('./stego/' + input_file_name + '_stego.pptx')
    os.rename('./stego/stego.zip', './stego/' + input_file_name + '_stego.pptx')
