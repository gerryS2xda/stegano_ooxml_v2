...
def apply_cell_table_style_into_sst(path_file_xlsx_extracted, tree_sst_input):
    ...
    for sheet in sheets:
        ...
        for table in table_parts:
            ...
            range_cell_table, table_style_name = extract_table_info_from_table_xml_file(path_file_xlsx_extracted, table_path)
...
def extract_table_info_from_table_xml_file(path_file_xlsx_extracted, table_path):
    ...
    range_cell_table = root_table_tag.get(TABLE_ROOT_ELEMENT_REF_ATTRIBUTE)
